...
class RecontagemSerialScreen extends StatefulWidget {
  @override
  _RecontagemSerialPageState createState() => _RecontagemSerialPageState();
}

class _RecontagemSerialPageState extends State<RecontagemSerialScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
        onWillPop: _cancelaRecontagemSerie,
        child: Scaffold(
          appBar: AppBar(
            title: Text("Recontagem - Serial"),
          ),
  ...
  Future<bool> _cancelaRecontagemSerie() async {
  ...
  Future<bool> _showDialogCancela() {
    return showDialog(
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              title: Text("Cancelando recontagem - serial"),
              content: Text(
                  "Confirma cancelar a recontagem de séries em andamento?"),
              actions: <Widget>[
                ElevatedButton(
                  style: ButtonStyle(
